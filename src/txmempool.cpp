...
CTxMemPoolEntry::CTxMemPoolEntry() : nFee(0), nTxSize(0), nUsageSize(0), nTime(0)
{
...
void CTxMemPool::removeCoinbaseSpends(const CCoinsViewCache* pcoins, int nMemPoolHeight)
{
